...
export const metadata: Metadata = {
	title: 'David Jumper - Software Engineer',
	description:
	...
	authors: [{ name: 'David Jumper' }],
	creator: 'David Jumper',
	openGraph: {
		title: 'David Jumper - Software Engineer Portfolio',
		...
		siteName: 'David Jumper - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'David Jumper - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
